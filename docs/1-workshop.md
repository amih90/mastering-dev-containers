...
1. Create a **devcontainer.json** file by opening the [Command Palette](https://code.visualstudio.com/docs/getstarted/userinterface#_command-palette) with `Ctrl` + `Shift` + `P` and selecting **Dev Containers: Add Dev Container Configuration Files...**.
...
You can validate it by opening the terminal using `Ctrl` + `Shift` + `~` and running `dotnet --version`, command to view the version of *Dotnet* installed in the environment.
...
<a href="0-prerequisites-ready-set-go.md"><img src="../assets/btn-previous.png" alt="Next" height="32"></a>
<a href="2-workshop.md"><img src="../assets/btn-next.png" alt="Next" height="32"></a>
</div>
